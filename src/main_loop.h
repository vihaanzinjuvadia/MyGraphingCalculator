...
int main_loop() {
    ...
    std::string f1 = "y=21x+69";
    std::string f2 = "cos(22)";
    std::string f3 =  "(x^2)/25 + (y^2)/16 = 1";
...
//    std::thread f1_data_gen_thread = std::thread(data_to_plot_simple, f1, plotting_data_f1);
//    std::thread f2_data_gen_thread = std::thread(data_to_plot_simple, f2, plotting_data_f2);
    std::thread f3_data_gen_thread = std::thread(data_to_plot_advanced, f3, plotting_data_f3);
